            ...
            for header in self.headers
            {
                ...
                if ( values.count > columnIndex && header != "" )
                {
                    ...
                    else if header == "Date"
                    {
                        ...
                        var dateValue : Date?
                        dateValue = formatter.date(from: textValue)
                        print ("textValue=\(textValue) dateValue=\(String(describing: dateValue))")
                        if dateValue == nil
                        {
                            let sep : Character = "-"
                            ...
                            if part >= 3
                            {
                                ...
                                print( "dayText=\(dayText) monthText=\(monthText) yearText=\(yearText)")
                                ...
                                dateValue = Calendar.current.date(from: dateComponents)
                                
                            }
                        }
                        if value != nil
                        {
                            value = dateValue as AnyObject?
                            rowValues["Date"] = dateValue as AnyObject
                        }
                    }
                    else
                    {
